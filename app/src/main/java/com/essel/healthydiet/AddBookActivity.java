...
public class AddBookActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        editTextKitapYazari = (EditText) findViewById(R.id.add_book_activity_editTextKitapYazarı);
        imgKitapResim = (ImageView) findViewById(R.id.add_book_activty_imageViewKitapResmi);
        ...
        if (!TextUtils.isEmpty(kitapIsmi)) {
            if (!TextUtils.isEmpty(kitapYazari)) {
                if (!TextUtils.isEmpty(kitapOzeti)) {
                    ...
                    showToast("Besin Değerleri Boş Olamaz.");
            } else
                showToast("Yiyecek Kategorisi Boş Olamaz.");
        } else
            showToast("Yiyecek İsmi Boş Olamaz.");
    }
